...
import FCM, { FCMEvent, RemoteNotificationResult, WillPresentNotificationResult, NotificationType } from "react-native-firebase";
...
class AuthLoader extends React.Component {
  ...
  constructor() {
    ...
    FCM.messaging().subscribeToTopic(topic);
